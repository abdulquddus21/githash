    ...
    <>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box}
        ...
        .admin-pill{background:rgba(124,58,237,0.14);color:var(--accent);padding:6px 8px;border-radius:8px;font-weight:700;font-size:13px;animation:pulse 2s infinite; margin-top:600px}
      ...
      <script dangerouslySetInnerHTML={{
        ...
        function validateFileType(file, allowedTypes = ['image/jpeg', 'image/png', 'image/gif', 'video/mp4', 'video/quicktime']) {
            if (!allowedTypes.includes(file.type)) {
                throw new Error(\`\${file.name} fayl turi qo'llab-quvvatlanmaydi. Faqat rasm (JPEG, PNG, GIF) va video (MP4, MOV) fayllari ruxsat etilgan.\`);
            }
            return true;
        }
